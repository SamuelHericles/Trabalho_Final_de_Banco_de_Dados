...
-- -----------------------------------------------------
-- Apagar o antigo esquema equipe385145
-- -----------------------------------------------------
DROP SCHEMA IF EXISTS `equipe385145` ;

-- -----------------------------------------------------
-- Criar um novo esquema equipe385145
-- -----------------------------------------------------
...
-- -----------------------------------------------------
-- Tabela de espaço reservado para exibição `view_professor_curso`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `view_professor_curso` (`nome` INT, `nome_curso` INT);
SHOW WARNINGS;

-- -----------------------------------------------------
-- Tabela de espaço reservado para exibição `view_livro_categoria`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `view_livro_categoria` (`titulo` INT, `nome_categoria` INT);
SHOW WARNINGS;

-- -----------------------------------------------------
-- Tabela de espaço reservado para exibição `view_livro_ano`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `view_livro_ano` (`titulo` INT, `ano` INT);
SHOW WARNINGS;

-- -----------------------------------------------------
-- Tabela de espaço reservado para exibição `view_livro_editora`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `view_livro_editora` (`titulo` INT, `editora` INT);
SHOW WARNINGS;

-- -----------------------------------------------------
--Tabela de espaço reservado para exibição `view_livro_autores`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `view_livro_autores` (`titulo` INT, `autores` INT);
SHOW WARNINGS;

-- -----------------------------------------------------
--Tabela de espaço reservado para exibição `view_reserva_livro`
-- -----------------------------------------------------
...
-- -----------------------------------------------------
-- View para `view_professor_curso`
-- -----------------------------------------------------
...
-- -----------------------------------------------------
-- View para `view_livro_categoria`
-- -----------------------------------------------------
...
-- -----------------------------------------------------
-- Dados para popular a tabela `autor`
-- -----------------------------------------------------
START TRANSACTION;
USE `equipe385145`;
...
-- -----------------------------------------------------
-- Dados para popular a tabela `usuario`
-- -----------------------------------------------------
START TRANSACTION;
USE `equipe385145`;
...
-- -----------------------------------------------------
-- Dados para popular a tabela `curso`
-- -----------------------------------------------------
START TRANSACTION;
USE `equipe385145`;
...
-- -----------------------------------------------------
-- Dados para popular a tabelae `aluno`
-- -----------------------------------------------------
START TRANSACTION;
USE `equipe385145`;
...
-- -----------------------------------------------------
-- Dados para popular a tabela `professor`
-- -----------------------------------------------------
START TRANSACTION;
USE `equipe385145`;
...
-- -----------------------------------------------------
-- Dados para popular a tabela `funcionario`
-- -----------------------------------------------------
START TRANSACTION;
USE `equipe385145`;
...
-- -----------------------------------------------------
-- Dados para popular a tabela `telefones`
-- -----------------------------------------------------
START TRANSACTION;
USE `equipe385145`;
...
-- -----------------------------------------------------
-- Dados para popular a tabela `categoria`
-- -----------------------------------------------------
START TRANSACTION;
USE `equipe385145`;
...
-- -----------------------------------------------------
-- Dados para popular a tabela `livro`
-- -----------------------------------------------------
START TRANSACTION;
USE `equipe385145`;
...
-- -----------------------------------------------------
-- Dados para popular a tabela `autor_livro`
-- -----------------------------------------------------
START TRANSACTION;
USE `equipe385145`;
...
-- -----------------------------------------------------
-- Dados para popular a tabela `emprestimo`
-- -----------------------------------------------------
START TRANSACTION;
USE `equipe385145`;
...
-- -----------------------------------------------------
-- Dados para popular a tabela `reserva`
-- -----------------------------------------------------
START TRANSACTION;
USE `equipe385145`;
